    ...
    <div className='flex h-screen justify-center items-center gap-10 px-4'>
      <div className='text-center max-w-3xl mx-auto'>
        ...
        <div className='flex flex-col items-center justify-center gap-5 mt-6 md:flex-row'>
          <Link
            href='/register'
            className='inline-block w-full sm:w-auto text-center min-w-[200px] px-6 py-4 text-white transition-all bg-gray-700  rounded-md shadow-xl sm:w-auto hover:bg-gray-900 hover:text-white shadow-neutral-300  hover:shadow-2xl hover:shadow-neutral-400 hover:-translate-y-1'
          >
            Register
          </Link>
        </div>
